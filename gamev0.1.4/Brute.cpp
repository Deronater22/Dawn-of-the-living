/***********************************************
	...
	The BruteEnemy class implementation

	Description: adds MD2 Brute style enemies mac 4/5/14
...
void BruteEnemy::OnCollision(Object *collisionObject)
{
...
void BruteEnemy::OnDraw(const Player&)
{
